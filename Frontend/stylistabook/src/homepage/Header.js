        ...
        <Row>
          <Col md={6} className="caption mt-60">
            <div className="o-hidden">
              <h1>
                Stylista Book <span>Makeup &amp; Hair Stylist</span>
              </h1>
              <p>
                Hello, we! love to help people feel beautiful, which is why
                we've spent the last 10 years immersed in doing makeup &amp;
                hair styling.
              </p>
